...
export default function ModelViewer({ project }: Props) {
  const { isLoading, setLoading, applySceneConfig, setSelectedMesh, setHoveredMesh } = useViewerStore();
  ...
  }, [project.id, project.defaultScene, setLoading, setSelectedMesh, setHoveredMesh, applySceneConfig]);
